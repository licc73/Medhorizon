...
#define BOKECC_USER_ID @"608FFD6E33B2DE5E"
#define BOKECC_APP_KEY @"qRTrQyHPQHEpVu45fVZyqrN8amDBRMY4"
...
- (id)initWithFrame:(CGRect)frame {
    if ( (self = [super initWithUserId:BOKECC_USER_ID key:BOKECC_APP_KEY]) ) {
